...
apt install -q -y php7.4 php7.4-common php7.4-cli php7.4-fpm python3-pip openvpn --allow-unauthenticated;
apt install -y -q php7.4-mysql php7.4-gd php7.4-json php7.4-sqlite3 php7.4-curl php7.4-zip php7.4-xml php7.4-mbstring php7.4-pgsql php7.4-bcmath;
...
apt install -q -y sqlite3 htop mediainfo cifs-utils smbclient dos2unix avahi-daemon avahi-discover avahi-utils libnss-mdns mdns-scan;
...
#EOF
##remove sql nasty password block / set to none please update your own with mywebsql##
